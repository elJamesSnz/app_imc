import 'package:app_delivery_flutter/src/pages/normal/main/normal_main_controller.dart';
...
class NormalMainPage extends StatefulWidget {
  const NormalMainPage({Key key}) : super(key: key);
...
class _NormalMainPageState extends State<NormalMainPage> {
  ...
  NormalMainController _con = new NormalMainController();
