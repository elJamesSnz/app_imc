import 'package:app_delivery_flutter/src/pages/bajo/main/bajo_main_controller.dart';
import 'package:app_delivery_flutter/src/utils/utils_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:lottie/lottie.dart';

class UserBajoMainPage extends StatefulWidget {
  const UserBajoMainPage({Key key}) : super(key: key);

  @override
  _UserBajoMainPageState createState() => _UserBajoMainPageState();
}

class _UserBajoMainPageState extends State<UserBajoMainPage> {
  UserBajoMainController _con = new UserBajoMainController();
