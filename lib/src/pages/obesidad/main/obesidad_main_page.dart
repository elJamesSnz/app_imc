import 'package:app_delivery_flutter/src/pages/obesidad/main/obesidad_main_controller.dart';
import 'package:app_delivery_flutter/src/utils/utils_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:lottie/lottie.dart';

class ObesidadMainPage extends StatefulWidget {
  const ObesidadMainPage({Key key}) : super(key: key);

  @override
  _ObesidadMainPageState createState() => _ObesidadMainPageState();
}

class _ObesidadMainPageState extends State<ObesidadMainPage> {

  ObesidadMainController _con = new ObesidadMainController();
